...
$url_ = "http://ws.demo.awan.sqiva.com/?&app=information&action=get_schedule_con&org=".$orig."&des=".$dest."&flight_date=".$flight_date."&return_flight=1&ret_flight_date=".$return_date."&extra_days=1";
...
$url_ = "http://ws.demo.awan.sqiva.com/?&app=information&action=get_schedule_con&org=".$orig."&des=".$dest."&flight_date=".$flight_date."&return_flight=0&ret_flight_date=&extra_days=1";
                $jsonUrl_ = file_get_contents($url_, False);
$json = json_decode($jsonUrl_,true);
//print_r($json);
echo '</br>';
